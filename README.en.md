...
> ✅ **Status: working product v2.8.4.** A 9-page dashboard (Overview, Traffic, Behavior, Funnel,
...
| ------------------------------------------------------------------------------------ | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v2.8.4** (Latest)                                                                  | 2026-05-28 | UTM-coverage fix (visit-weighted from utm_stats, was 0%); detailed docs (user-guide, quickstart, data-model)                                                                      |
