...
> ✅ **Status: working product v2.8.3.** A 9-page dashboard (Overview, Traffic, Behavior, Funnel,
...
| ------------------------------------------------------------------------------------ | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v2.8.3** (Latest)                                                                  | 2026-05-28 | Goals progress fix (counts purchase payments), Executive Summary in full HTML + «Final conclusion» section, full-screen UTM-Sankey, GOST DOCX/PDF title page without empty blocks |
