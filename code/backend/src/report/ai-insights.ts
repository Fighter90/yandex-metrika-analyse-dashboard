...
export const AI_FORMAT_RULES =
  ...
  '2. НЕ нумеруй собственные подзаголовки. Запрещено писать «1. Где мы сейчас», «2. Анализ», ' +
  '«Шаг 1. …», «Раздел 1. …». Заголовок — только смысловая тема: «Где мы сейчас», «Анализ каналов». ' +
  'Сквозную нумерацию разделов добавляет сам отчёт.\n' +
  ...
  '6. ОБЪЁМ: каждый раздел ≤ 7 абзацев, каждый абзац ≤ 4-5 предложений.';
