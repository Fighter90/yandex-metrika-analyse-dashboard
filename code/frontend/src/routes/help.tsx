    ...
    <section className="space-y-8">
      ...
      <Section title="Как работает дашборд" icon="🏗️">
        ...
        <p className="mt-3 text-sm text-slate-600">
          <b>Подписи под графиками.</b> Под каждым графиком есть блок «🟢 Корректно / 🔴 Внимание /
          💡 Рекомендация»: откуда берутся данные (таблица SQLite, прослеживается до сырого ответа
          Метрики), известное ограничение и что с этим делать. Цифры по каналам сверены с
          Яндекс.Метрикой и совпадают по дням за тот же период.
        </p>
      </Section>
        ...
        <div className="mt-3 space-y-3 text-sm text-slate-600">
          <div>
            <p className="font-medium">
              📅 Пресеты периода: <b>7д</b> / <b>14д</b> / <b>30д</b> / <b>90д</b> / <b>1г</b>
            </p>
            <p>
              Быстрый выбор периода: последние 7, 14, 30, 90 дней или 1 год. При нажатии данные на
              странице автоматически перезагружаются за новый период.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              позволяет выбрать произвольный период, например, с 1 по 15 мая. Максимальный период —
              365 дней (1 год).
            </p>
          </div>
          <div>
      ...
      <Section title="Обзор" icon="📊">
        ...
        <div className="mt-3 space-y-2 text-sm text-slate-600">
          ...
          <ul className="ml-4 list-inside list-disc space-y-1">
            <li>
              <b>Дайджест за неделю:</b> карточка с визитами и заявками за последние 7 дней,
              сравнением с предыдущей неделей (WoW, стрелки ▲/▼), топ-каналом по визитам и главным
              слабым местом.
            </li>
            <li>
      ...
      <Section title="Трафик" icon="🔗">
        ...
        <div className="mt-3 space-y-2 text-sm text-slate-600">
          ...
          <ul className="ml-4 list-inside list-disc space-y-1">
            ...
            <li>
              <b>Поток: источник → кампания → заявки</b> (Sankey): толщина связей источник→кампания
              — по визитам, кампания→«Заявки» — по достижениям целей. Видно, какие UTM-источники
              реально доводят трафик до заявок (трафик без меток «(none)» в поток не попадает).
            </li>
          </ul>
      ...
      <Section title="Поведение" icon="📄">
        ...
        <div className="mt-3 space-y-2 text-sm text-slate-600">
          ...
          <p className="mt-2">
            <b>Ограничение:</b> Яндекс.Метрика не отдаёт атрибут <code>ym:s:exitURL</code> для этого
            счётчика, поэтому данные по страницам выхода обычно пусты, и блок «Страницы выхода»
            скрывается при отсутствии данных. Это не ошибка — измерение недоступно на стороне
            Метрики.
          </p>
        </div>
      </Section>
      ...
      <Section title="Воронка" icon="🔻">
        ...
        <div className="mt-3 space-y-2 text-sm text-slate-600">
          ...
          <p className="font-medium mt-2">Дополнительные графики:</p>
          <ul className="ml-4 list-inside list-disc space-y-1">
            <li>
              <b>CR по каналам:</b> конверсия каждого канала (заявки / визиты), ограничена
              диапазоном 0–100%.
            </li>
            <li>
              <b>Воронка по каналам:</b> рядом стоят столбцы визитов и заявок по топ-каналам —
              видно, какой канал доводит до заявки, а какой даёт трафик «вхолостую».
            </li>
            <li>
              <b>Конверсия по странам:</b> заявки в разбивке по гео.
            </li>
          </ul>
      ...
      <Section title="Настройки" icon="⚙️">
        ...
        <div className="mt-3 space-y-2 text-sm text-slate-600">
          ...
          <ul className="ml-4 list-inside list-disc space-y-1">
            ...
            <li>
              <b>COUNTER_ID:</b> ID вашего счётчика Метрики (задаётся в <code>.env</code>).
            </li>
            <li>
      ...
      <Section title="Частые вопросы" icon="❓">
        <div className="space-y-4 text-sm text-slate-600">
          ...
          <FAQ question="Как изменить период на графиках?">
            Используйте пресеты 7д/14д/30д/90д/1г в шапке или нажмите «Даты» для выбора
            произвольного периода (макс. 365 дней). Данные на странице автоматически перезагрузятся.
          </FAQ>
