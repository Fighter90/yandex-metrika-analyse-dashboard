...
| **Стадия**       | v2.5.7 — рабочий продукт, фазы A–D завершены                                                                                                                                                                                   |
...
Навигация (`Layout.tsx`) — 12 страниц, каждый график с подписью «🟢 корректно / 🔴 внимание / 💡 рекомендация».

| Страница      | Что показывает                                                                                                                                                         |
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Обзор**     | дайджест за неделю (WoW), KPI-стрип (цель 300, заявки, gap), графики: визиты/заявки по дням, микс каналов, **топ стран** (bar), **доля устройств** (donut), weak spots |
...
| **Гипотезы**  | AI-генерация problem/solution гипотез, ICE-сортировка, риски, планы проверки                                                                                           |
| **Решения**   | Decision Log: CRUD решений, привязка к гипотезам, светофор                                                                                                             |
| **B2B**       | CRUD-таблица сделок, pipeline по этапам (lead/negotiation/invoiced/paid)                                                                                               |
| **Отчёт**     | сборка snapshot, AI-анализ (опц.), экспорт DOCX/PDF (ГОСТ Р 7.32-2017), полный просмотр отчёта на экране                                                               |
| **История**   | список сформированных snapshot-ов с переходом на просмотр                                                                                                              |
| **Настройки** | ключ/токен/счётчик (save/clear), большая кнопка «Обновить данные из Метрики» с прогрессом                                                                              |
...
7. **Текущий релиз:** v2.5.7. Семантическое версионирование + CHANGELOG.
