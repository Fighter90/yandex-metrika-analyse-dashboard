...
> ✅ **Статус: рабочий продукт v2.9.1.** Дашборд из 9 страниц (Обзор, Трафик, Поведение,
...
| -------------------------------------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v2.9.1** (Latest)                                                                    | 2026-05-29 | Финальная полировка AI-DOCX: убраны эмодзи/двойная нумерация в AI-заголовках, лимит длины AI-секций, титул без пустых прогонов, KPI-лейбл из goalLabel, дедуп URL страниц, маска API-ключа в Настройках |
