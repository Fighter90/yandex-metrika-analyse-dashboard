...
> ✅ **Статус: рабочий продукт v2.8.3.** Дашборд из 9 страниц (Обзор, Трафик, Поведение,
...
| -------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v2.8.3** (Latest)                                                                    | 2026-05-28 | Фикс прогресса «Целей» (учёт оплат-покупок), Executive Summary в полном HTML + секция «Итоговый вывод», разворот UTM-Sankey, ГОСТ-титул DOCX/PDF без пустых блоков          |
