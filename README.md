...
> ✅ **Статус: рабочий продукт v2.5.6.** Дашборд из 9 страниц (Обзор, Трафик, Поведение,
...
| -------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------- |
| **v2.5.6** (Latest)                                                                    | 2026-05-27 | Hotfix билда/гейта (TS в DOCX/фронте) + синхронизация версий, 100% coverage |
