...
> ✅ **Статус: рабочий продукт v2.7.0.** Дашборд из 9 страниц (Обзор, Трафик, Поведение,
...
| -------------------------------------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v2.7.0** (Latest)                                                                    | 2026-05-27 | Навигация → 9 страниц; AI-гипотезы и AI Decision Log в отчёте; B2B-пайплайн в Настройках; formatGoalLabel («Оплат»); единая палитра цветов каналов                  |
