...
> ✅ **Статус: рабочий продукт v2.8.4.** Дашборд из 9 страниц (Обзор, Трафик, Поведение,
...
| -------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v2.8.4** (Latest)                                                                    | 2026-05-28 | Фикс UTM-покрытия (визит-взвешенно из utm_stats, было 0%); подробные docs (user-guide, quickstart, data-model)                                                              |
