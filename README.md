...
> ✅ **Статус: рабочий продукт v2.8.5.** Дашборд из 9 страниц (Обзор, Трафик, Поведение,
...
| -------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v2.8.5** (Latest)                                                                    | 2026-05-28 | Актуализация QA регресс-промта (M-004 закрыт) + синхронизация версии в документах                                                                                           |
