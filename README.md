...
> ✅ **Статус: рабочий продукт v2.8.1.** Дашборд из 9 страниц (Обзор, Трафик, Поведение,
...
| -------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v2.8.1** (Latest)                                                                    | 2026-05-28 | Доступность WCAG AA: контраст текста ≥4.5:1, клавиатурный доступ к таблицам — 0 нарушений axe на 9 страницах                                                                |
