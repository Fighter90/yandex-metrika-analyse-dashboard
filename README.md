...
> ✅ **Статус: рабочий продукт v2.9.0.** Дашборд из 9 страниц (Обзор, Трафик, Поведение,
...
| -------------------------------------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **v2.9.0** (Latest)                                                                    | 2026-05-28 | Переработка DOCX/PDF-отчёта: убраны дубли секций по каналам, очистка AI-нарратива от markdown, компактное приложение, AI-промпт без своей нумерации, AI-кнопка блокируется после генерации |
