...
flowchart TD
  ...
  UI[React 18 + Vite дашборд<br/>12 страниц + мобильное меню] -- TanStack Query --> API
...
## Страницы дашборда (12)

| Страница  | URL           | Описание                                                                                          |
| --------- | ------------- | ------------------------------------------------------------------------------------------------- |
| Обзор     | `/`           | KPI-стрип, дайджест за неделю (WoW), визиты/заявки, микс каналов, weak spots, подписи 🟢/🔴/💡    |
...
| Гипотезы  | `/hypotheses` | Список + форма гипотез (структурированный формат гипотез: ≥3 допущения, ≥2 метода, ICE, светофор) |
| Решения   | `/decisions`  | Decision Log, DL-{N}, связь с гипотезами, CSV-экспорт                                             |
| B2B       | `/b2b`        | CRUD ручного B2B-пайплайна                                                                        |
